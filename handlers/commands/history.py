...
from database.get_history_from_db import get_history_db
from database.get_hotels_from_db import get_hotels_db
from utils.main_functions.help_func import help_message
from utils.misc.history_message import get_history_message
...
def get_history(message: types.Message, bot:TeleBot, session: Session) -> None:
	"""
	Handler for history command. Get history from db and send it into the chat
